...
const ItemTooltip = (props: Props) => {
	...
	return (
		<div
			ref={props.ref}
			class="border-tooltip absolute top-10 z-50 box-border hidden min-w-[10rem] max-w-[18rem] flex-col gap-2 whitespace-pre-line p-1 pt-0 text-left font-display font-light text-stone-800 shadow-xl"
		>
